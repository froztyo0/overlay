...
function updateImage() {
    overlayImage.src = "https://github.com/froztyo0/pixelmaker/blob/main/outputs/overlay_target.png?raw=true" + Date.now()
}

setInterval(function () {overlayImage.src = "https://github.com/froztyo0/pixelmaker/blob/main/outputs/overlay_target.png?raw=true" + Date.now()}, 30000);
